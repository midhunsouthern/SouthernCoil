...
import { getProfileDataURL, setNewProfileData, getUsersData } from '../../constant/url';
                    ...
                    <TableRow key={row.id} onClick={handleSelectedRow(row.id)}>
                        ...
                        <TableCell  align="left">
                          ...
                          <Tooltip title="Delete" id={"tooldelete"+row.id}>
                              <IconButton  color='error' onClick={() => handleDelete(row.id)} key={"icbtndel"+row.id }>
                                  <DeleteIcon />
                              </IconButton>
                          </Tooltip>
                        </TableCell>
                          ...
                          <div className="col-sm-6">
                            <Container>
                              ...
                              <FormControl fullWidth>
                                <InputLabel id="access_type_lbl" style={{ "margin-top" : '16px', "margin-bottom":'8px'  }} 
                                shrink={true}
                                ...
                                >{
                                    accessTypeList?.map(option => {
                                      return (
                                        <MenuItem key={option.access_type} value={option.access_type}>
                                          {option.access_type ?? option.access_type}
                                        </MenuItem>
                                      );
                                    })
                                }
