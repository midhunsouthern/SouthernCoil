				...
				<nav className="nav">
					...
					<div className="top">
						...
						<ul className="navigation navbar-top">
							...
							{accessModuleList.filter((x) => x.module_name === "CreateUser")[0]
								.access_rw === "1" && (
								<li className="item">
									<div className="link">
										<NavLink
							...
							{accessModuleList.filter(
								(x) => x.module_name === "CreateCustomer"
							)[0].access_rw === "1" && (
								<li className="item">
									<div className="link">
										<NavLink
							...
							{accessModuleList.filter((x) => x.module_name === "Scheduler")[0]
								.access_rw === "1" && (
								<li className="item">
									<div className="link">
										<NavLink
