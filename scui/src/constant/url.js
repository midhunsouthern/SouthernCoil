...
// export const baseURL = "https://demo.southerncoil.com/backend/index.php/";
export const axiosInstances=axios.create({baseURL})
...
export const getCncProgramList = baseURL + "main/get_cnc_program_list";
...
export const cnc_delete_order = baseURL + "main/delete_cnc_order";
...
export const getCncCompletedPrograms = baseURL + "main/get_cnc_completed_programs";
export const saveCncCompletedPrograms = baseURL + "main/save_cnc_completed_programs";
...
export const cnc_pgm_data = baseURL + "main/save_cnc_program";
